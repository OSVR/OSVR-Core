    ...
    namespace reftracker {
        ...
        TransformParams const &getRefTrackerTransformParams() {
            static const TransformParams data =
                (TransformParams() << -1.328683782476265, 1.405860857175348,
                 2.382413079481474, -0.08838304984947577, -0.3418371322988537,
                 0.08973247977775475, 0.04221099149748584, -0.289480834047175,
                 -0.1169425186552738, -0.03623604095935174, -0.0460904237026321,
                 0.001219163540875095)
                    .finished();
            return data;
        }
