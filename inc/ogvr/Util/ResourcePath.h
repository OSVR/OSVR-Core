...
/** @brief Class representing a host and resource path in the OGVR logical system.
...
class ResourcePath {
    public:
        ...
        /// @brief Go to the named child. The name may include slashes for multiple levels.
        ...
        /// @brief Gets the path following the hostname as a string, starting with a leading slash.
