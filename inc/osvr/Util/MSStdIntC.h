/** @file
    @brief A stdint implementation for old version of Visual Studio,
    automatically included if needed by <osvr/util/StdInt.h>

    Origin: http://snipplr.com/view/18199/stdinth/ from user `mwb1100`
    "A public domain stdint.h. Original code is from a public domain version
    in the MinGW distribution. This one has been modified to fix a couple
    bugs (to make some macros 64-bit aware) and to make it compatible with VC6."
