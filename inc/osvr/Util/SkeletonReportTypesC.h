...
/** @brief defines the elements that are available in skeleton as per OSVR Skeleton Spec. */
...
/** @brief There are various types of skeleton reports that allow to get different skeleton joints/bones. Note, Each report can include information from one skeleton sensor due to connectedness of skeleton. Refer to the definition of each report below for a complete description of which bones are included */
...
/** @brief Report for Skeleton Level of Articulation 1 (LOA1)
    ...
    Head, Neck, Clavicle Left/Right (Shoulders), Arm Upper Left/Right (Elbows), Hand Left/Right (Wrists), Spine 0/1/2/3 (Center spine), Pelvis, Leg Upper Left/Right (Hips), Leg Lower Left/Right (Knees), Foot Left/Right
*/ 
typedef struct OSVR_SkeletonLOA1Report{
    uint32_t sensor;
    /** @brief a collection of tracker reports */
    OSVR_PoseReport states[OSVR_SKELETON_REP_LOA1];
} OSVR_SkeletonLOA1Report;
...
/** @brief Report for One Hand (Left or Right)
    Each hand report includes : Hand (Wrist), Thumb/Index/Middle/Ring/Pinky Proximal/Medial/Distal
*/ 
...
/** @brief Report for a single Arm (Left or Right)
    Each hand report includes : Clavicle, Arm Upper, Arm Lower, Hand, Thumb/Index/Middle/Ring/Pinky Proximal/Medial/Distal
*/ 
