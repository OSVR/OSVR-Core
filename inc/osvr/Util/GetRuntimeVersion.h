...
#ifndef INCLUDED_GetRuntimeVersion_h_GUID_FF76C4D7_2239_4DA3_0216_19D9473788E8
...
namespace util {
    ...
    OSVR_UTIL_EXPORT util::NumericVersionComponent
    getVersionComponent(uint8_t componentIndex);

    /// @brief Gets all numeric components of the runtime version in a tuple.
    OSVR_UTIL_EXPORT util::RuntimeNumericVersion getRuntimeNumericVersion();
    ...
    OSVR_UTIL_EXPORT const char *getCIBuildTag();
    ...
    OSVR_UTIL_EXPORT bool isKnownDevBuild();
    ...
    OSVR_UTIL_EXPORT const char *getModuleName();
} // namespace util
} // namespace osvr

#endif // INCLUDED_GetRuntimeVersion_h_GUID_FF76C4D7_2239_4DA3_0216_19D9473788E8
