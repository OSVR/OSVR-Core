...
OSVR_INTERFACE_CALLBACK_METHOD(SkeletonJoint)
OSVR_INTERFACE_CALLBACK_METHOD(SkeletonWhole)
OSVR_INTERFACE_CALLBACK_METHOD(SkeletonTrimmed)
OSVR_INTERFACE_CALLBACK_METHOD(SkeletonHand)
OSVR_INTERFACE_CALLBACK_METHOD(SkeletonArm)
OSVR_INTERFACE_CALLBACK_METHOD(SkeletonFoot)
OSVR_INTERFACE_CALLBACK_METHOD(SkeletonLeg)
