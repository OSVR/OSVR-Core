...
inline void register##TYPE##Callback(OSVR_##TYPE##Callback cb, void *userdata);
...
/* TODO
inline Interface::Interface(OSVR_ClientContext context, const std::string& path)
{
...
inline Interface::Interface(OSVR_ClientInterface interface) : m_interface(interface)
{
    // do nothing
}
...
#define OSVR_CALLBACK_METHODS(TYPE)                                            \
inline void Interface::register##TYPE##Callback(OSVR_##TYPE##Callback cb, void *userdata)\
{\
    osvrRegister##TYPE##Callback(m_interface, cb, userdata); /* always returns SUCCESS */ \
}
